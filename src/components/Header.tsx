...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50">
      ...
      {/* Nav */}
      <nav
        className={`border-y border-brand-cream bg-white/95 backdrop-blur transition-shadow ${
      ...
      >
        <div className="mx-auto flex max-w-[1400px] items-center justify-between gap-4 px-4 py-2">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <Link
              href="/pay-now"
              className="inline-flex items-center gap-1.5 whitespace-nowrap rounded-[10px] bg-emerald-600 px-3.5 py-2.5 text-sm font-semibold text-white transition hover:bg-emerald-700 sm:gap-2 sm:px-4"
            >
            ...
            <div className="absolute inset-x-0 top-full z-50 flex max-h-[82vh] flex-col overflow-y-auto border-t border-brand-cream bg-white shadow-2xl">
              ...
              <div className="px-4 pb-3">
                <Link
                  href="/pay-now"
                  onClick={closeMenu}
                  className="mb-2 block rounded-[10px] bg-emerald-600 px-4 py-2.5 text-center text-sm font-semibold text-white"
                >
                  💳 Pay Now
                </Link>
